...
template<typename WS_TYPE> [[nodiscard]] phantomchat::contracts::PerSocketData *get_session(WS_TYPE *ws) noexcept
...
void handleSendMessage(APP_TYPE &app,
  WS_TYPE *ws,
  const phantomchat::services::RoomManager &room_manager,
